...
from asr2k.config import data_path
from asr2k.bin.download_model import download_acoustic_model, download_language_model


def resolve_acoustic_model(lang_id, checkpoint=None):
    ...
    if lang_id in public_models:
        model_name = public_models[lang_id]
    else:
        model_name = public_models['default']

    download_acoustic_model(model_name)
...
def resolve_language_model(lang_id, checkpoint=None):
    download_language_model(lang_id)
